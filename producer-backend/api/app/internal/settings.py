...
class OAuth2Settings:
    client_id = get_variable_str("OAUTH2SETTINGS_CLIENT_ID")
    client_secret = get_variable_str("OAUTH2SETTINGS_CLIENT_SECRET")
    token_url = get_variable_str("OAUTH2SETTINGS_TOKEN_URL")
    refresh_token_url = get_variable_str("OAUTH2SETTINGS_REFRESH_TOKEN_URL")
    revoke_token_url = get_variable_str("OAUTH2SETTINGS_REVOKE_TOKEN_URL")
    userinfo_endpoint = get_variable_str("OAUTH2SETTINGS_USERINFO_ENDPOINT")
    scope = get_variable_str("OAUTH2SETTINGS_SCOPE")
    authorize_url = get_variable_str("OAUTH2SETTINGS_AUTHORIZE_URL")
    verify = get_variable_bool("OAUTH2SETTINGS_VERIFY", True)
    grant_type = get_variable_str("OAUTH2SETTINGS_GRANT_TYPE")
    redirect_uri = get_variable_str("OAUTH2SETTINGS_REDIRECT_URI")
    authorization_response = get_variable_str("OAUTH2SETTINGS_AUTHORIZATION_RESPONSE")
...
class AppRoutesSettings:
    ...
    error_page = "/api/fail"
    error_page_frontend = "https://producer.smartland.lan/error"
    login_page_frontend = "https://producer.smartland.lan/"
    home_url = "https://producer.smartland.lan/home"
